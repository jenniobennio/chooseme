...
static CGFloat const kAwesomeMenuDefaultStartPointY = 520.0; /*240.0;*/
static CGFloat const kAwesomeMenuDefaultTimeOffset = 0.036f;
static CGFloat const kAwesomeMenuDefaultRotateAngle = 3.2 * M_PI_2;
static CGFloat const kAwesomeMenuDefaultMenuWholeAngle = (8.0/10) * M_PI;
